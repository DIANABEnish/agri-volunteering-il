...
const VolunteerMap = ({ locations, onLocationSelected }) => {
  ...
  const getResponsiveStyle = () => {
    ...
    if (window.innerWidth <= 320) {
      return { ...baseStyle, height: '100vh', width: '90%' };
    } else if (window.innerWidth <= 375) {
      return { ...baseStyle, height: '90vh', width: '80%' };
    } else if (window.innerWidth <= 413) {
      return { ...baseStyle, height: '75vh', width: '85%' };
    } else if (window.innerWidth <= 480) {
      return { ...baseStyle, height: '80vh', width: '95%' };
    } else if (window.innerWidth <= 600) {
      return { ...baseStyle, height: '80vh', width: '90%' };
